    ...
    >
      ...
      >
        <svg viewBox="0 0 480 420" className="w-full h-auto" aria-hidden="true">
          ...
          >
            <rect x="0" y="76" width="58" height="48" rx="10"
              style={{ fill: "var(--bg-secondary)", stroke: "var(--accent)" }}
              strokeWidth="1.5"
            />
            <text x="29" y="94" textAnchor="middle" dominantBaseline="middle"
              fontFamily="Poppins, sans-serif" fontWeight="800" fontSize="8.5"
          ...
          >
            <rect x="0" y="296" width="58" height="48" rx="10"
              style={{ fill: "var(--bg-secondary)", stroke: "var(--border-color)" }}
              strokeWidth="1.5"
            />
            <text x="29" y="314" textAnchor="middle" dominantBaseline="middle"
              fontFamily="Poppins, sans-serif" fontWeight="800" fontSize="8.5"
          ...
          >
            <rect x="406" y="200" width="74" height="40" rx="10"
              style={{ fill: "var(--accent)" }}
            />
            <text x="443" y="220" textAnchor="middle" dominantBaseline="middle"
